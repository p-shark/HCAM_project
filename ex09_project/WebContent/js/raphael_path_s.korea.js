	...
	for (var state in aus) {
		...
		(function (st, state) {
			...
			st[0].onclick = function () {
				...
				switch(state) {
					case "seoul":
						$('.select_box').val('CCD01001').trigger('change');
						current = state;
						break;
					case "gygg":
						$('.select_box').val('CCD01002').trigger('change');
						current = state;
						break;
					case "incheon":
						$('.select_box').val('CCD01003').trigger('change');
						current = state;
						break;
					case "gangwon":
						$('.select_box').val('CCD01004').trigger('change');
						current = state;
						break;
					case "chungbuk":
						$('.select_box').val('CCD01005').trigger('change');
						current = state;
						break;
					case "chungnam":
						$('.select_box').val('CCD01006').trigger('change');
						current = state;
						break;
					case "daejeon":
						$('.select_box').val('CCD01007').trigger('change');
						current = state;
						break;
					case "sejong":
						$('.select_box').val('CCD01008').trigger('change');
						current = state;
						break;
					case "jeonbuk":
						$('.select_box').val('CCD01010').trigger('change');
						current = state;
						break;
					case "gwangju":
						$('.select_box').val('CCD01009').trigger('change');
						current = state;
						break;
					case "jeonnam":
						$('.select_box').val('CCD01011').trigger('change');
						current = state;
						break;
					case "gyeongbuk":
						$('.select_box').val('CCD01012').trigger('change');
						current = state;
						break;
					case "daegu":
						$('.select_box').val('CCD01014').trigger('change');
						current = state;
						break;
					case "gyeongnam":
						$('.select_box').val('CCD01013').trigger('change');
						current = state;
						break;
					case "ulsan":
						$('.select_box').val('CCD01016').trigger('change');
						current = state;
						break;
					case "busan":
						$('.select_box').val('CCD01015').trigger('change');
						current = state;
						break;
					case "jeju":$('.select_box').val('CCD01017').trigger('change');location.href="#jeju";
						current = state;
						break;
